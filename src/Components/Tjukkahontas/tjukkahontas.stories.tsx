...
import { TjukkahontasSignature } from "./tjukkahontas";
 ...
 */
const meta = {
  title: "Components/TjukkahontasSignature",
  component: TjukkahontasSignature,
  parameters: {
  ...
  args: {},
} satisfies Meta<typeof TjukkahontasSignature>;
